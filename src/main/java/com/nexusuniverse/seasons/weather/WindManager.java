        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            if (weightEnabled) {
                ...
                weightMultiplier = player.isGliding()
                        ...
                        ? lerp(config.windGlidePushMultiplierEmpty(), config.windGlidePushMultiplierFull(), fullness)
                        // On foot/swimming: a full inventory's extra weight anchors you against being pushed.
                        : lerp(config.windGroundPushMultiplierEmpty(), config.windGroundPushMultiplierFull(), fullness);
            }
