 ...
 * Particle.BLOCK_CRUMBLE using that block's own real BlockData), a low rumble sound, and a chance
...
public class EarthquakeManager {
    ...
    private void spawnGroundCrumble(Player player) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            world.spawnParticle(Particle.BLOCK_CRUMBLE, point, 3, 0.2, 0.1, 0.2, 0.0, ground.getBlockData());
        }
    }
