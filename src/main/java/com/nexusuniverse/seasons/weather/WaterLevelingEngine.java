...
final class WaterLevelingEngine {
     ...
     * capped at maxBlocksPerPass so one call can't cause a large, noticeable pause. Returns how
     * many blocks were actually filled.
     */
    static int levelArea(Location center, int radius, int maxBlocksPerPass) {
